...
import { Spinner, Alert, Button } from "flowbite-react"; // Keep Spinner and Alert if you like them
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {users?.map((user) => (
          <div
          key={user.id}
          className="relative group bg-pink-200 border border-pink-400 p-4 rounded-2xl shadow-lg overflow-hidden"
        >
          {/* Glitter GIF overlay */}
          <img
            src="/flower.gif" // Make sure this file is inside your /public folder
            alt="Glitter"
            className="absolute inset-0 w-full h-full opacity-0 group-hover:opacity-60 transition duration-300 pointer-events-none"
          />
